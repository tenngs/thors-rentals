...
## How to install dependicies for Windows<br>
### MinGW & gcc compiler
...
### Notes
1) I have provided the required sqlite3.o and sqlite3.h files in the repo. However, it is not guaranteed that it will work on your computer just because it works on mine. If in doubt, please follow the installation steps above.
## Compiling
