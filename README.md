...
### Notes
1) I have provided the required sqlite3.o file in the repo. However, it is not guaranteed that it will work on your computer just because it works on mine. If in doubt, please follow the installation steps above.
## Compiling
